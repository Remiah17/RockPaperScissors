...
document.querySelector(".shootButton").onclick = function(){shootGame()};
document.querySelector(".oneRound").onclick = function(){setRound(1)};
document.querySelector(".threeRound").onclick = function(){setRound(3)};
document.querySelector(".fiveRound").onclick = function(){setRound(5)};
updateScore();
...
function setRound(roundNum)
{
  if(player1Score == 0 && player2Score == 0)
  {
    ...
    {
      case 1:
      document.querySelector(".oneRound").classList.remove("btn-outline-warning");
      document.querySelector(".oneRound").classList.add("btn-warning");
      document.querySelector(".threeRound").classList.add("btn-outline-warning");
      document.querySelector(".threeRound").classList.remove("btn-warning");
      document.querySelector(".fiveRound").classList.add("btn-outline-warning");
      document.querySelector(".fiveRound").classList.remove("btn-warning");
      break;
      case 3:
      document.querySelector(".threeRound").classList.remove("btn-outline-warning");
      document.querySelector(".threeRound").classList.add("btn-warning");
      document.querySelector(".oneRound").classList.add("btn-outline-warning");
      document.querySelector(".oneRound").classList.remove("btn-warning");
      document.querySelector(".fiveRound").classList.add("btn-outline-warning");
      document.querySelector(".fiveRound").classList.remove("btn-warning");
      break;
      case 5:
      document.querySelector(".fiveRound").classList.remove("btn-outline-warning");
  ...
  {
    alert("It is impossible to change the number of rounds while in game. Refresh the page to start a new round.");
  }
}
...
function shootGame()
{
  if(scoreToWin > 0)
  {
    ...
    {
      case 1: //it is ROCK
        document.querySelector(".gameImg1").setAttribute("src","images/rock.png");
        document.querySelector(".moveDes1").textContent = "Rock!";
        break;
      case 2: //it is Paper
        document.querySelector(".gameImg1").setAttribute("src","images/paper.png");
        document.querySelector(".moveDes1").textContent = "Paper!";
        break;
      case 3://it is Scissors`1
        document.querySelector(".gameImg1").setAttribute("src","images/scissors.png");
    ...
    {
      case 1: //it is ROCK
        document.querySelector(".gameImg2").setAttribute("src","images/rock.png");
        ...
        break;
      case 2: //it is Paper
        document.querySelector(".gameImg2").setAttribute("src","images/paper.png");
      ...
      case 3://it is Scissors
        document.querySelector(".gameImg2").setAttribute("src","images/scissors.png");
